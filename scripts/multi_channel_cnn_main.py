...
if __name__ == "__main__":
    HOLD_EMBEDDINGS = pre_process.create_hold_embedding_vectors(hold_quality, hold_angles.permute(2, 0, 1))

    grid_encoded_data, grades_tensor, grades = pre_process.pull_in_data()

    grid_encoded_data = grid_encoded_data * HOLD_EMBEDDINGS  # tensor shape (59787, 2, 18, 11) num_samples by embedding vector by moonboard grid shape
    ...
    model = predictions_models.MultiChannelCNN(2, 20, len(grades))
